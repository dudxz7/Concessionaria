...
) AS imagem_padrao FROM modelos m LEFT JOIN detalhes_modelos d ON m.id = d.modelo_id GROUP BY m.id";
...
if (!defined('CARDS_SIMPLES_JS')) {
    define('CARDS_SIMPLES_JS', true);
    echo '<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(".card-simples").forEach(function(card) {
            card.addEventListener("click", function(e) {
                // Não redireciona se clicar no botão do coração
